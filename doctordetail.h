#ifndef DOCTORDETAIL_H
#define DOCTORDETAIL_H
...
class DoctorDetail : public QDialog
{
    Q_OBJECT

public:
    explicit DoctorDetail(QWidget *parent = nullptr);
    ~DoctorDetail();
    QSqlDatabase db;
    void viewDoctor();
    bool addDoctor();
    QSqlQuery* searchDoctor(QString);
